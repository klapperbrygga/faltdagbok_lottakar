...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <html lang="en" xml:lang="en">
            <head>
                <title>
                    ...
                    on your browsers tab--> DCHM Template: Lästext </title>
                <!-- load bootstrap css (requires internet!) so you can use their pre-defined css
                classes to style your html -->
                <link rel="stylesheet"
                    href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
                    integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T"
                    crossorigin="anonymous" />
                <!-- load the stylesheets in the assets/css folder, where you can modify the styling
                of your website -->
            ...
            <body>
                ...
                <nav id="sitenav">
                    <a href="index.html">Hem</a> | <a href="diplomatic.html">Diplomatisk
                    Transkription</a> | <a href="reading.html">Lästext</a> | <a href="toplayer.html">
                    Galleri</a> | <a href="personer-1-kopia.html">Lista på Lottor</a>
                </nav>
                <main id="manuscript">
                    <!-- bootstrap "container" class makes the columns look pretty -->
                    <div class="container">
                        <!-- define a row layout with bootstrap's css classes (two columns with
                        content, and an empty column in between) -->
                        <div class="row">
                            <div class="col-">
                                <h3>Bilder</h3>
                            </div>
                        ...
                        <!-- set up an image-text pair for each page in your document, and start a
                        new 'row' for each pair -->
                        <xsl:for-each select="//tei:div[@type='page']">
                            <!-- save the value of each page's @facs attribute in a variable, so we
                            can use it later -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-">
                                    <article>
                                        <!-- make an HTML <img> element, with a maximum width of 100
                                        pixels -->
                                        <img class="thumbnail">
                                            <!-- give this HTML <img> attribute three more
                                            attributes:
                                                  ...
                                                  we use the substring-after() function because when we match our page's @facs with the <surface>'s
                                            @xml:id,
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <article id="details">
                                    <p>
                                        <strong>Mer att läsa:</strong>
                                        <br />
                                        <xsl:value-of select="tei:orgName:org[4]"/><xsl:text> </xsl:text>
    ...
    <!-- how to read the match? "For all tei:hi elements that have a rend attribute with the value
    "u", do the following" -->
